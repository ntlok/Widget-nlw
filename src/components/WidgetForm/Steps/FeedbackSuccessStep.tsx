...
export function FeedbackSuccessStep({ sentAgain }: FeedbackSuccessProps) {
  ...
  return (
    <div>
      ...
      <div className="w-[304px] p-10 flex flex-col items-center gap-4">
        ...
        <button 
          onClick={sentAgain}
          type="button" 
          className="py-2 px-6 text-zinc-100 text-sm leading-6 bg-zinc-800 rounded-md max-w-[170px] 
          border-transparent hover:bg-zinc-700 transition-colors focus:outline-none
          focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brands-500 
          transition-colors disabled:opacity-50 disabled:hover:bg-brands-500"
        >
          Quero Enviar outro
        </button>
